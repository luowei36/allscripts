...
pinName = ''
UA=''
helpShareFlag='true' #是否优先助力[助力池]，默认true | 优先[内部助力]改为 false
inviteIdCodesArr=[]
shareCodesArr=[]
newShareCodes=[]
inviteCodes=['RtGKsaj9AG3qDeTzc4xlmkx8n6NnkT_r6E0seHKF9vqlje6P','yQVaHnk0lp8NMs_WF5h_mqcXpz-TS5-ZWryumLXT']
